...
try:
    ...
    if news_context:
        ...
        2. 각 기사의 원문 링크는 요약본 바로 옆이나 아래에 그대로 유지해줘.
        3. 강조용 마크다운 기호(예: **)는 절대 사용하지 말 것.
        4. 전체 내용을 '핵심 요약'과 '주요 용어 정리' 두 가지 섹션으로 명확히 구분할 것.
        5. 각 내용은 한 줄에 하나의 문장만 들어가도록 줄바꿈을 철저히 하고, 숫자 번호(1., 2., 3.)를 붙여서 나열해 줘."
